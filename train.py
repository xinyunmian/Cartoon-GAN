...
def parse_args():
    ...
    parser.add_argument('--start_iter', type=float, default=1, help='The learning rate')
    parser.add_argument('--lr', type=float, default=0.0001, help='The learning rate')
    parser.add_argument('--adv_weight', type=int, default=1.0, help='Weight for GAN')
    parser.add_argument('--cycle_weight', type=int, default=50.0, help='Weight for Cycle')
    parser.add_argument('--identity_weight', type=int, default=20.0, help='Weight for Identity')
    parser.add_argument('--cam_weight', type=int, default=2000.0, help='Weight for CAM')
    parser.add_argument('--faceid_weight', type=int, default=0.7, help='Weight for Face ID')
    ...
    parser.add_argument('--pretrained_weights', type=str, default='./models/photo2cartoon.pt', help='pretrained weight path')
    #parser.add_argument('--pretrained_weights', type=str2bool, default=False, help='pretrained weight path')
